...
@Component({
  selector: "app-newsletter-signup-features",
  templateUrl: "./newsletter-signup-features.component.html",
  styleUrls: ["./newsletter-signup-features.component.scss"],
})

export class NewsletterSignupFeaturesComponent implements OnInit {
