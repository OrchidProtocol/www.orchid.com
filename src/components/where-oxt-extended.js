	...
	<div className="where-oxt">
		...
		<div className="oxt-row">
			<div className="oxt-column">
				<h3 className="gap-top-thin"><Trans>Exchange Listings</Trans></h3>
			...
			<div className="oxt-column slim">
				<h3 className="gap-top-thin"><Trans>Decentralized Listings</Trans></h3>
				<div className="listing-container">
					<div className="listing-col">
			...
			<div className="oxt-column">
				<h3 className="gap-top-thin"><Trans>Wallet &amp; Custody Partners</Trans></h3>
				<div className="listing-container">
					<div className="listing-col">
