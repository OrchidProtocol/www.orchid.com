...
const Component = () => (
	<div class="where-oxt">
		...
		<a href="https://www.coinbase.com/price/orchid">
			<img class="margin" src="/img/where-oxt/coinbase.png" srcset="/img/where-oxt/coinbase.png, /img/where-oxt/coinbase@2x.png 2x, /img/where-oxt/coinbase@3x.png 3x" alt="Coinbase" />
		</a>
		<a href="https://gemini.com/prices/orchid">
			<img class="margin" src="/img/where-oxt/gemini.png" alt="Gemini" />
		</a>
		<a href="https://www.okex.com/en/spot/trade/oxt_usdt">
			<img class="margin" src="/img/where-oxt/okex.png" alt="OKEx" style={{ width: "150px" }} />
		</a>
		<a href="https://global.bittrex.com/Market/Index?MarketName=BTC-OXT">
			<img class="margin" src="/img/where-oxt/bitrex.png" alt="Bittrex" />
		</a>
		<a href="https://www.kraken.com/">
			<img class="margin" src="/img/where-oxt/kraken.svg" alt="Kraken" />
		</a>
		<a href="https://www.bitcoin.com/">
			<img class="margin" src="/img/where-oxt/bitcoin-com.png" alt="Bitcoin.com" />
		</a>
		<a href="https://www.binance.com/?ref=NE62QDGW">
			<img class="margin" src="/img/where-oxt/binance.svg" alt="Binance" />
		</a>
		<br />
		<br />
		<a href="/oxt">View the full list</a>
		<h3 class="gap-top-wide" i18n="@@OXTContract">OXT Contract on Ethereum</h3>
