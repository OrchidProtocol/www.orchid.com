...
const Page = () => (
	<Layout>
		<Helmet>
			<title>Decentralization is the new encryption | Orchid</title>
			<meta name="description" content="Decentralization is the new encryption presentation - how decentralized and encrypted technologies complement each other for better privacy solutions." />
