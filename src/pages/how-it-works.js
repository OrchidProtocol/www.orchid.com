						...
						<div className="explainer__container">
							...
							<div className="explainer__text">
								...
								<div i18n="@@HowOxt__Content">
									...
									<p>Accordingly, in addition to facilitating bandwidth transactions on the Network, the Orchid digital currency is used to prove a stake within the Orchid network that demonstrates a commitment by bandwidth providers, as well as to mitigate
										certain risks.</p>
								</div>
							</div>
							<div className="explainer__image">
