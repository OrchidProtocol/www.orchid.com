...
class Page extends React.Component {
	...
	render() {
		return (
			<Layout>
				<WebsiteMeta
					title="OXT Digital Currency | Orchid"
					description="OXT is an Ethereum (ERC-20) digital currency used to exchange value on the Orchid network. Orchid offers VPN privacy tools at an affordable cost."
				...
				<div className="tokenomics bk-faint-gray">
					<section className="section-med hpad-wide vpad-wide z-index-1">
						...
						<div i18n="@@OXTStakingBody">
							...
							<p>
								<Link to="/how-it-works">Read more about provider staking here.</Link>
							</p>
						</div>
					</section>
				</div>
