					...
					<section className="join-steps__grid section-wide">
						...
						<div className="join-step step-3">
							...
							<div className="join-step__content">
								...
								<p>
									<Trans>Download the Orchid app for <a href={this.state.androidLink} data-appstorelink>Android</a>, <a href={this.state.iOSLink} data-appstorelink>iOS</a> or <a href={this.state.iOSLink} data-appstorelink>macOS</a></Trans>
								</p>
