...
const Page = () => (
	<Layout>
		<Helmet>
			<title>Our Partners | Orchid</title>
		...
		<div class="partners-hero bk-beige-light">
			<section class="section-med hpad-wide vpad-xl center-text z-index-1">
				<div class="hero__text">
					<h1 class="partners-hero__title">Orchid Partnerships</h1>
					<br />
					<p class="partners-hero__subtitle">
					...
					<br />
					<a href="/contact">
						<button class="btn-primary btn__hero z-index-1">Discuss Partnership</button>
					</a>
				</div>
				<div class="hero__patterning"></div>
				<div class="hero__image">
				</div>
			</section>
		</div>

		<div class="partners-wrapper bk-white">
			<div class="overflow-wrapper">
				<section class="section-med hpad-thin vpad-wide z-index-1" id="vpn">
		...
		<div class="partners-wrapper bk-lavender">
			<div class="overflow-wrapper">
				<section class="section-med hpad-thin vpad-wide z-index-1" id="wallet">
					<div class="center-text">
		...
		<div class="partners-wrapper bk-white">
			<div class="overflow-wrapper">
				<section class="section-med hpad-thin vpad-wide z-index-1" id="exchange">
					<div class="center-text">
		...
		<div class="partners-wrapper bk-lavender">
			<div class="overflow-wrapper">
				<section class="section-med hpad-thin vpad-wide z-index-1" id="other">
					<div class="center-text">
		...
		<div class="patterning-instance-2"></div>
